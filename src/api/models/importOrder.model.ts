...
const ALLOWED_FIELDS = ['_id', 'order_code', 'customer', 'delivery_address', 'delivery_time', 'note', 'productIDs', 'created_at', 'updated_at'];
  ...
  async get(id: any) {
    try {
      ...
      if (mongoose.Types.ObjectId.isValid(id)) {
        order = await this.findById(id).populate('customer',['id','email']).populate('productIDs').exec();
      }
